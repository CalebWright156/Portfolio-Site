        ...
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
          <div className='col-span-2'>
            ...
            <p className='py-2 text-[#CFCFCF]'>
                I have spent the last few years studying psychology and accounting at University. I have always had a knack and love for technology and working with computers ever since childhood. Last year during my holidays I thought I would learn HTML and CSS to make edits for my mothers small business website she was working on. What I thought would be a fun way to pass my time during University holidays has evolved into a love for programming. 
            </p>
            <p className='py-2 text-[#CFCFCF]'>
