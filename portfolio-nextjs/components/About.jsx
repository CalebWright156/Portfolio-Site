        ...
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
          <div className='col-span-2'>
            ...
            <p className='py-2 text-[#CFCFCF]'>
                I have spent the past few years studying Psychology and Accounting at the Queensland University of Technology in Australia. While I have always had a passion for technology and computer work, it was not until late 2021 that I started to learn coding. Initially, this was a great way for me to pass the time during the holidays. I worked with my friends to help them create websites for their small businesses and taught myself a wide range of skills. What began as a hobby has evolved into a passion for programming and learning.
            </p>
            <p className='py-2 text-[#CFCFCF]'>
