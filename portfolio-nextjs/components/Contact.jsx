  ...
  return (
    <div id='contact' className='w-full lg:h-screen'>
        <div className='max-w-[1240px] m-auto px-2 py-16 w-full'>
            <p className='text-xl tracking-widest font-bold uppercase text-[#4984a4]'>Contact</p>
                ...
                <div className='col-span-3 w-full bg-[#CFCFCF] text-[#414141] font-bold h-auto shadow-xl shadow-gray-800 rounded-xl lg:p-4'>
                    <div className='p-4'>
                        <form method='POST' data-netlify='true' name='contact' action='/formsubmitted'>
                            ...
                            <button type='submit' className='w-full p-4 text-[#414141] mt-4'>Send Message</button>
                        </form>
                    </div>
                </div>
            </div>
